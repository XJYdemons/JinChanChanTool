...
[功能特性](#功能特性) • [快速开始](#快速开始) • [使用文档](#使用文档) • [下载安装](#下载安装) • [常见问题](#常见问题) • [参与贡献](#参与贡献)
...
详细配置步骤请参阅 [第2章 开始使用](./第2章%20开始使用.md)
...
### Q: GPU推理如何配置？
A: 首次使用时在配置向导中选择GPU推理，程序会自动检测GPU环境并引导您完成配置。详细说明请参阅 [使用GPU推理OCR.md](./使用GPU推理OCR.md)
