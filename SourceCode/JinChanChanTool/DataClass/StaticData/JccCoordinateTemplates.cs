...
namespace JinChanChanTool.DataClass.StaticData
{
    ...
    public static class JccCoordinateTemplates
    {
        ...
        /// <summary>
        /// 棋盘盲点拾取网格（5 个点，右键点击触发英雄移动拾取）
        /// 前两行网格（行1 x3 + 行2 x2，共 5 点），英雄移动路径自动拾取掉落物
        /// </summary>
        public static readonly AnchorProfile[] PickupPoints = new AnchorProfile[]
        {
            new(-350, -630, 20, 20),   // 行1左
            new(-50,  -630, 20, 20),   // 行1中
            new(250,  -630, 20, 20),   // 行1右
            new(-350, -470, 20, 20),   // 行2左
            new(250,  -470, 20, 20),   // 行2右
        };
    }
}