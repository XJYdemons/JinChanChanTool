...
namespace JinChanChanTool.Tools
{
    public static class ImageProcessingTool
    {
        ...
        public static Bitmap AreaScreenshots(int x, int y, int width, int height)
        {
            ...
            {
                // 设置高质量绘制参数
                screenshot.InterpolationMode = InterpolationMode.HighQualityBicubic;
                screenshot.SmoothingMode = SmoothingMode.HighQuality;
                screenshot.PixelOffsetMode = PixelOffsetMode.HighQuality;
                screenshot.CompositingQuality = CompositingQuality.HighQuality;
